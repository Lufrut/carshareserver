...
router.delete('/deleteCar/:id',authAdminMiddleware,adminController.deleteUser)
router.delete('/deleteAdmin/:id',checkAdminLevelMiddleware(1),adminController.deleteUser)
